...
// ─── Data ──────────────────────────────────────────────────────────────────────
const CONTACT_ITEMS = [
  { icon: MapPin, text: '22960 E Roxbury Dr., Unit D, Aurora, CO, 80016', href: 'https://maps.google.com/?q=22960+E+Roxbury+Dr+Unit+D+Aurora+CO', external: true },
  { icon: Phone,  text: '720-666-4797',                                   href: 'tel:+17206664797', external: false },
...
const getCTAButtonBaseStyle = ({ solid = false } = {}) => ({
  ...
  gap: '6px',
  minWidth: 'clamp(110px, 18vw, 140px)',
  minHeight: 'clamp(38px, 6vw, 42px)',
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 'clamp(16px, 3vw, 24px)' }}>
              ...
              >
                ...
                <Link
                  ...
                  style={getCTAButtonBaseStyle({ solid: false })}
                  onMouseEnter={e => {
                ...
                <Link
                  to="/demo"
                  className="cta-button"
                  style={getCTAButtonBaseStyle({ solid: true })}
                  onMouseEnter={e => {
                    e.currentTarget.style.background  = 'transparent';
                    e.currentTarget.style.color       = '#16a34a';
                    e.currentTarget.style.boxShadow   = 'none';
          ...
          <div style={{ padding: 'clamp(8px, 2vw, 8px) clamp(20px, 5vw, 24px) clamp(24px, 6vw, 40px)', display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 'clamp(10px, 2vw, 12px)', marginTop: 'clamp(24px, 5vw, 32px)' }}>
              <Link
                ...
                className="cta-button"
                style={{
                  ...getCTAButtonBaseStyle({ solid: false }),
                  width: '100%',
                  justifyContent: 'center',
                }}
              >Pricing</Link>
              <Link
                ...
                className="cta-button"
                style={{
                  ...getCTAButtonBaseStyle({ solid: true }),
                  width: '100%',
                  justifyContent: 'center',
                }}
              >Book a Demo</Link>
